...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO users (login, password, email, first_name, last_name, date, role) VALUES (?, ?, ?, ?, ?, ?, 'user')";
    $stmt = mysqli_prepare($conn, $query);
...
<head>
    ...
    <title>CodeMaster - Регистрация</title>
    ...
    <div class="auth-container">
        ...
        <form action="register.php" method="post">
            ...
            <div class="login-options">
                <p>или</p>
                <br>
                <a href="admin_register.php">Регистрация для администратора</a>
            </div>
        </form>
    </div>
